            ...
            <div class="col-12 mb-50" >
                ...
                <div class="post-block-wrapper">
                    ...
                    <div class="head sports-head">
                        ...
                        <!-- Title -->
                        <h4 class="title">Membres du bureau Ligue Centre Nord</h4>
                    ...
                    <div class="body">
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-4 mb-3">
                                <div class="card p-0">
                                    <div class="card-image">
                                        <img src="{{ asset('img/default-man.png') }}"
                                            alt="">
                                    </div>
                                    <div class="card-content d-flex flex-column align-items-center smallHeadline ">
                                        <h4>1 er Vice Président</h4>
                                        <h5>YASSINE LAZRAK</h5>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-lg-4 mb-3">
                                <div class="card p-0">
                                    ...
                                    <div class="card-content d-flex flex-column align-items-center smallHeadline ">
                                        <h4>Assesseur (Directeur Technique) </h4>
                                        <h5>IMAD MOHAMED</h5>
                                    </div>
                                </div>
                            </div>
